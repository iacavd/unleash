...
for lib in colors result config detect validate dscl suppress backup pipeline status heal firewall harden whitelist check monitor doctor selfupdate uninstall report ma_detect automate webhook; do
